...
- "SPECIALIZATION" label is vertically rotated (`writing-mode: vertical-rl; rotate(180deg)`) and housed _inside_ a custom flex border (`.skill-specialization`) alongside 3 rows of checkbox/text inputs.
