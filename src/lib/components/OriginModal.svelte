<script lang="ts">
    ...
    import type { Origin } from '$lib/store.svelte';
            ...
            <div class="origins-grid">
                ...
                >
                    ...
                    <p>
                        ...
                        gain an extra general perk (like an Animal Pet) to represent their broader
                        capabilities.
                    </p>
                </button>
                ...
                >
                    ...
                    <p>
                        ...
                        objects with telekinesis and master complex spells.
                    </p>
                </button>
            </div>
                ...
                <div class="options-grid">
                    <div class="essence-selector">
                        <label for="diamond-essence"
                            >Diamond Essence (+2)<br /><small>Your fastest growing essence</small
                            ></label
                        >
                        <select
                            id="diamond-essence"
                    ...
                    <div class="essence-selector">
                        <label for="gold-essence"
                            >Gold Essence (+1)<br /><small
                                >Your second fastest growing essence</small
                            ></label
                        >
                        <select
                            id="gold-essence"
