<script lang="ts">
    ...
    import cutieMarksList from '$lib/data/cutiemarks';
    ...
    >
        <div class="modal-content">
            ...
            <div class="cutie-mark-grid">
                ...
                <div
                    class="cutie-mark-item"
                    onclick={selectRandom}
                    onkeydown={(e) => e.key === 'Enter' && selectRandom()}
                    role="button"
                    tabindex="0"
                >
                    <img
                ...
                {#each cutieMarksList as filename (filename)}
                    <div
                        class="cutie-mark-item"
                        onclick={() => selectCutieMark(filename)}
                        onkeydown={(e) => e.key === 'Enter' && selectCutieMark(filename)}
                        role="button"
                        tabindex="0"
                    >
                        <img
