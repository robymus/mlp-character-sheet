...
export const SKILL_SPECIALIZATIONS: Record<string, Specialization[]> = {
	...
	might: [
		{
			name: 'Grappling',
			description: 'Restraining a target by overpowering them and limiting how they can move.',
		},
		{
			name: 'Shoving',
	...
	acrobatics: [
		...
		{
			name: 'Flying',
			description: 'Turning, diving, and flipping in three-dimensional space using air movement.',
		},
		{
			name: 'Gymnastics',
	...
	finesse: [
		...
		{
			name: 'Steady Hoof',
			description: 'The more precise the movement, the more comfortable you are executing it.',
		},
	],
	infiltration: [
		{
	...
	targeting: [
		...
		{
			name: 'Trajectory',
			description: 'Calculating the verticals and horizontals, and where incoming fire came from.',
		},
	],
	...
	science: [
		...
		},
		{
			...
			description: 'A specific scientific discipline, like Biology, Chemistry, or Mathematics.',
		},
	],
	survival: [
		{
	...
	deception: [
		...
		{
			name: 'Disguise',
			description: 'Alter appearance or how you carry yourself to come off as somepony different.',
		},
		{
			name: 'Misdirect',
			description: 'Planting an idea in a way that makes somepony believe they thought it up.',
		},
	],
	performance: [
		{
