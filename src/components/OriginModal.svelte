<script lang="ts">
  ...
  function selectOrigin(o: Origin) {
    localOrigin = o;
    if (o === 'Earth Pony') {
      localDiamond = 'strength'; localGold = 'social';
    } else if (o === 'Pegasus') {
      localDiamond = 'speed'; localGold = 'strength';
    } else if (o === 'Unicorn') {
      localDiamond = 'smarts'; localGold = 'social';
    }
  }
</script>
  ...
  <div class="modal-content">
    ...
    <div class="origins-grid">
      ...
      >
        ...
        <h3>Earth Pony</h3>
        <p>Earth Ponies are naturally resilient and deeply connected to the land. They gain an extra general perk (like an Animal Pet) to represent their broader capabilities.</p>
      </button>
      ...
      >
        ...
        <h3>Pegasus</h3>
        <p>Pegasi have the unique ability to fly and walk on clouds. They are naturally agile and masters of the sky.</p>
      </button>
      ...
      >
        ...
        <h3>Unicorn</h3>
        <p>Unicorns possess a horn that allows them to channel magic. They can move objects with telekinesis and master complex spells.</p>
      </button>
    </div>
    ...
    <div class="options-container">
      <div class="options-grid">
        <div class="essence-selector">
          <label for="diamond-essence">Diamond Essence (+2)<br/><small>Your fastest growing essence</small></label>
          <select id="diamond-essence" value={localDiamond} onchange={(e) => updateDiamond(e.currentTarget.value as EssenceType)}>
        ...
        <div class="essence-selector">
          <label for="gold-essence">Gold Essence (+1)<br/><small>Your second fastest growing essence</small></label>
          <select id="gold-essence" value={localGold} onchange={(e) => updateGold(e.currentTarget.value as EssenceType)}>
            <option value="strength">Strength</option>
            <option value="speed">Speed</option>
            <option value="smarts">Smarts</option>
            <option value="social">Social</option>
