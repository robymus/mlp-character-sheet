...
<div class={`stat-column ${type}`}>
		...
		<div class="header-content">
			<h2>
				...
				<div class="essence-controls">
					...
					>
						<button class="essence-btn" onclick={decrement} disabled={!canDecrement}>-</button>
					</Tooltip>
	...
	<div class="derived-stat">
		...
		<div class="derived-formula">
			...
			<span>+</span>
			<div class="formula-box">
				<input type="number" id={`${type}-prk`} readonly /><label for={`${type}-prk`}>PERKS</label>
			</div>
			<span>+</span>
			<div class="formula-box">
				<input type="number" id={`${type}-arm`} readonly /><label for={`${type}-arm`}>ARMOR</label>
			</div>
		</div>
	</div>
